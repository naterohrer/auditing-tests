...
# check for luks else other linux ecrytion
...
#https://wiki.archlinux.org/title/Trusted_Platform_Module#:~:text=check%20the%20logs%2C%20e.g.%2C%20by%20running%20journalctl,the%20necessary%20software%20dependencies:%20$%20systemd%2Danalyze%20has%2Dtpm2.
check_boot_security() {
